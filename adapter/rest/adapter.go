...
type RagServer interface {
	...
	ListFileDocuments(ctx context.Context, principal authz.Principal, id ragserver.FileID, filter ragserver.DocumentFilter, limit int) ([]ragserver.Document, error)
